...
def tema():
    ...
    return pagina("Sporturi",
        """<h1>Sporturi</h1>
        <p>Tema proiectului este sporturi. Elementul ales este biatlon.</p>
        <a href="/sporturi/biatlon">Biatlon</a>""")


@app.route("/sporturi/biatlon")
def sport():
    """Pagina elementului ales."""
    return pagina("Biatlon",
        """<h1>Biatlon</h1>
        <p>Biatlonul este un sport de iarna care combina schiul fond cu tirul sportiv.</p>
