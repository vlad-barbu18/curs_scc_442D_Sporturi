...
Element ales: Inot.
Cele 4 rute conform cerintei din ghid:
- /sporturi                         -> pagina temei
- /sporturi/inot                    -> pagina elementului ales
- /sporturi/inot/concursuri         -> functia 1: concursuri internationale
- /sporturi/inot/inotatori          -> functia 2: inotatori profesionisti
"""
...
@app.route("/sporturi/inot/concursuri")
def concursuri():
...
@app.route("/sporturi/inot/inotatori")
def inotatori():
