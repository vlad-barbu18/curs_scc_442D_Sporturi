...
def pagina_html(titlu, continut, afiseaza_home=True):
    """
...
def discipline_echitatie():
    ...
    <div class="card">
        ...
        <p>
        Aceasta disciplina presupune depasirea unui traseu cu obstacole
        intr-un timp cat mai bun si fara penalizari.
        </p>
    </div>
    ...
    <div class="card">
        <h2>Dresaj</h2>
        <p>
        Dresajul pune accent pe eleganta, precizie si controlul
        miscarilor calului.
        </p>
    </div>
    ...
    <div class="card">
        <h2>Polo</h2>
        <p>
        Polo este un sport de echipa in care jucatorii incearca sa
        introduca mingea in poarta adversa folosind un baston special.
        </p>
    </div>
    """

    return pagina_html("Discipline Echitatie", continut)
...
def echipamente_echitatie():
    ...
    <p>
    Echipamentele potrivite asigura siguranta, confortul si o comunicare
    mai buna intre cal si calaret.
    </p>

    <img src="/static/imagini/echipamente_echitatie.jpeg"
         alt="Echipamente echitatie">

    <ul>
        <li><b>Saua</b> ofera stabilitate si confort calaretului.</li>
    ...
    return pagina_html("Echipamente Echitatie", continut)
