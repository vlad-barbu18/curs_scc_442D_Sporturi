...
INFO_1 = [
    {"camp1": "Origine", "camp2":
 "Scrima provine din tehnicile de lupta cu sabia practicate încă din Antichitate și Evul Mediu."},
    {"camp1": "Tip", "camp2":
 "Sport olimpic individual tehnic si tactic"
"deoarece pune accent pe viteza, precizie, coordonare si strategie."},
]
...
INFO_2 = [
    ...
    ("Spada",
 "Arma mai grea decat flotanta unde intreaga suprafata "
"a corpului este zona valida pentru punctaj"),
]
...
def functie_2_scrima():
    ...
    html += (
         '<img src="https://patranescu.wordpress.com/wp-content/uploads/2011/04/arme_scrima.gif"'
         'width="400" style="border-radius: 12px; margin-top: 20px;">'
)
    html += '</div>'
    return html
